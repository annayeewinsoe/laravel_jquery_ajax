...
$(document).ready(function () {
  ...
  $('#add_member_btn').on('click', function () {
    var member_name = $('#add_member').val();
  ...
  $('#search_member').on('submit', function (e) {
    e.preventDefault();
    var term = $(this).find('input').val().trim();
...
module.exports = __webpack_require__(/*! D:\_projects\laravel\laravel_ajax\resources\js\main.js */"./resources/js/main.js");
